...
class GameRoot extends GameManager {
  ...
  GameRoot(int width, int height, int bombCount, this.stage, this.resourceManager) : super(width, height, bombCount) {
  ...
  void onGameStateChanged(GameState newState) {
    if (newState == GameState.won) {
      ...
      if (game.duration.inMilliseconds < _gameElement.scoreElement.bestTime || _gameElement.scoreElement.bestTime == 0) {
