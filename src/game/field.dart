...
class Field extends Array2d<bool> {
  ...
  factory Field([int bombCount = 40, int cols = 16, int rows = 16, int seed = null]) {
    ...
    return new Field._internal(bombCount, cols, new UnmodifiableListView<bool>(squares));
  }
  ...
  factory Field.fromSquares(int cols, int rows, List<bool> squares) {
    ...
    return new Field._internal(count, cols, new UnmodifiableListView<bool>(squares));
  }
