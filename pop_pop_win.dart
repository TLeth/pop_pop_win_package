...
Future startGame(PlatformTarget platform) {
  ...
  var stage = new Stage(querySelector('#gameCanvas'), webGL: true, color: 0xb4ad7f, frameRate: 60);
  ...
  var resourceManager = new ResourceManager()..addTextureAtlas("static", '$_ASSET_DIR/images/static.json', TextureAtlasFormat.JSON);
...
void _initialLoad(ResourceManager resourceManager, Stage stage) {
  ...
  resourceManager
      ..addTextureAtlas('opaque', '$_ASSET_DIR/images/opaque.json', TextureAtlasFormat.JSON)
      ..addTextureAtlas('animated', '$_ASSET_DIR/images/animated.json', TextureAtlasFormat.JSON);
  ...
  resourceManager.load().then((resMan) => _secondaryLoad(resMan, stage, loadingSprite));
}

void _secondaryLoad(ResourceManager resourceManager, Stage stage, Sprite loadingSprite) {
